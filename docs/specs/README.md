...
| FS-16 | [features/FS-16-dependent-work.md](features/FS-16-dependent-work.md) | Partial | Durable tasks, armed starts, task waiting, lineage, scoped repair, and planned named dependency selection |
