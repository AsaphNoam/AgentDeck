# AgentDeck — Archived session briefs through 2026-08-21

These are historical human updates moved out of the live brief file on 2026-08-24. They are retained
for project history only; agents resume from [`../../features/HANDOFF.md`](../../features/HANDOFF.md)
and follow the current workflow and specifications.
