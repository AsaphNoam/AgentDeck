# AgentDeck — handoff state settled through 2026-09-10

Archived under AGENT-WORKFLOW §16.7 as part of cutting `v0.4.3`, to keep the live handoff header
inside its session-start budget. Everything below is settled history: the v0.4.3 range's changelog
entries and the completed bug investigation reports whose fixes shipped in that release. Findings
those reports left open stay live in [`../../features/HANDOFF.md`](../../features/HANDOFF.md).
