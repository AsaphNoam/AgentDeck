...
INSERT INTO pipeline_attempts(
  ...
  agent_id, agent_generation, backend, model, effort, fast, state, assignment_text,
  ...
  quiescent_at, created_at, updated_at
		...
		attempt.AgentID, attempt.AgentGeneration, attempt.Backend, attempt.Model, attempt.Effort, attempt.Fast, attempt.State, attempt.AssignmentText,
