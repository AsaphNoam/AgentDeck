...
SELECT
    a.agent_id, a.name, a.role, a.project, a.backend, a.model, a.effort, a.interface, a.grp, a.created_at, a.archived,
...
WHERE a.agent_id = ?`, agentID)
	...
	err := row.Scan(
		&out.AgentID, &out.Name, &out.Role, &out.Project, &out.Backend, &out.Model, &out.Effort,
