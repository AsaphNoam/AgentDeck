...
func ProjectEvent(ev runtime.Event) (Projection, error) {
	...
	case runtime.EvSessionMeta, runtime.EvBackendSwitch, runtime.EvActivityStarted, runtime.EvActivityState, runtime.EvBackgroundTaskState, runtime.EvForkBoundary:
