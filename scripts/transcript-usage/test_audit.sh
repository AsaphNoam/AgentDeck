...
EOF
out=$(python3 scripts/transcript-usage/audit.py --claude-root "$test_root/claude" --codex-root "$test_root/codex" --cwd /workspace/agentdeck --from 2026-08-01 --to 2026-08-02 --json)
